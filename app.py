...
def main():
    ...
    with tab1:
        ...
        if sel_regions:
            ...
            st.plotly_chart(px.line(sub_m, x='날짜', y=sel_regions, markers=True).update_layout(height=350, paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)'), use_container_width=True)
            ...
            st.plotly_chart(px.line(sub_j, x='날짜', y=sel_regions, markers=True).update_layout(height=350, paper_bgcolor='rgba(0,0,0,0)', plot_bgcolor='rgba(0,0,0,0)'), use_container_width=True)
    ...
    with tab3:
        ...
        c1, c2 = st.columns(2)
        with c1:
            st.markdown('<p style="font-weight:900; text-align:center; color:#D32F2F;">[매매 주간 상승]</p>', unsafe_allow_html=True)
        ...
        with c2:
            st.markdown('<p style="font-weight:900; text-align:center; color:#01579B;">[전세 주간 상승]</p>', unsafe_allow_html=True)
        ...
        c3, c4 = st.columns(2)
        with c3:
            st.markdown('<p style="font-weight:900; text-align:center; color:#7F6000;">[매매 누적 상승]</p>', unsafe_allow_html=True)
        ...
        with c4:
            st.markdown('<p style="font-weight:900; text-align:center; color:#1B5E20;">[전세 누적 상승]</p>', unsafe_allow_html=True)
