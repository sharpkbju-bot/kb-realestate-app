...
def main():
    ...
    if sel_region != "지역을 입력하세요.":
        ...
        fig_m.update_layout(
            ...
            xaxis=dict(title=None, tickfont=dict(size=12, color='#000080', weight=900)),
            yaxis=dict(title=None, tickfont=dict(size=12, color='#000080', weight=900))
        )
